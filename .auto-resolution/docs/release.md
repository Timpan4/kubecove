...
Release tags run type checks, unit tests, Rust tests and checks, deterministic fast E2E, and real E2E across supported Kubernetes matrix before installers build. Workflow verifies installer assets, updater signatures, `latest.json`, and updater platform coverage before publishing.
