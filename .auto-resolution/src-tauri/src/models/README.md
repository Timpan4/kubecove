...
Current domains include cluster, namespace, resource, discovery, events, streams, sessions, metrics, Argo CD, Helm, RBAC, usage, and error models.
...
- Future operation models must include explicit target scope and frontend-safe results.
