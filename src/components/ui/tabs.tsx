...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cnfast(tabsListVariants({ variant }), className)}
      {...props}
    />
  )
}
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cnfast("flex-1 text-xs/relaxed outline-none", className)}
      {...props}
    />
  )
}
