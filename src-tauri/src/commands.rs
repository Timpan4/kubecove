use crate::models::{
    ...
    DiscoveredResourceKind, NamespaceSummary, ResourceDetailsFull, ResourceEventSummary,
    ResourceSummary,
};
...
async fn fetch_and_serialize_cluster<
