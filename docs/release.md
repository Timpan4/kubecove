...
GitHub Actions then runs typecheck, frontend tests, Rust tests, Rust check, builds macOS, Windows, and Linux installers, and publishes a GitHub Release. Manual workflow dispatch is only for rerunning an existing `app-v*` tag.
