...
Latest published release: [`0.10.0`](https://github.com/Timpan4/kubecove/releases/tag/app-v0.10.0).

Current `main` keeps `0.10.0` metadata until a release PR prepares the next version. Features merged after the `0.10.0` tag are not present in those installers.
