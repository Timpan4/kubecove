...
Current version metadata: `0.10.3`. [GitHub Releases](https://github.com/Timpan4/kubecove/releases) is authoritative for successfully published installers. Source features are not released until the matching tag completes all release gates.
